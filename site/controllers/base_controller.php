...
class BaseController{
    ...
    function render($file, $data = array())
    {
      ...
      $view_file = 'site/views/' . $this->folder . '/' . $file . '.php'; // site/views/pages/sanpham.php
      if (is_file($view_file)) {
        ...
        require_once('site/views/layouts/layout.php');
      } else {
        // Nếu file muốn gọi ra không tồn tại thì chuyển hướng đến trang báo lỗi.
        header('Location: index.php?controller=sanpham_controller&action=error');
      }
    }
}
?>